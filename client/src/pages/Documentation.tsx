...
const Documentation = () => {
  return (
    <div className="p-6 space-y-6 bg-[#030712] min-h-screen text-slate-100">
      ...
      <div className="bg-[#0b1329] p-8 rounded-xl border border-blue-900/40 shadow-lg max-w-3xl">
        <h3 className="text-sm font-bold text-white mb-3">Panduan Penggunaan</h3>
        ...
        <div className="space-y-4 border-t border-blue-950 pt-4">
          <div>
            <h4 className="text-xs font-bold text-blue-400">1. Sinkronisasi Data OMSPAN & SAKTI</h4>
          ...
          <div>
            <h4 className="text-xs font-bold text-blue-400">2. Indikator Fiscal Stress</h4>
            <p className="text-[11px] text-slate-400 leading-relaxed mt-1">
          ...
          <div>
            <h4 className="text-xs font-bold text-blue-400">3. Mesin Deteksi Anomali AI</h4>
            <p className="text-[11px] text-slate-400 leading-relaxed mt-1">
